    ...
    def get_vars(self, play=None, host=None, task=None, include_hostvars=True, include_delegate_to=True, use_cache=True,
        ...
        if host:
            ...
            inventory_dirs = tuple(
                ...
                # skip invalid dirs and host lists
                if inventory_dir is not None and (',' not in inventory_dir or os.path.exists(inventory_dir))
            )
            ...
            def _plugins_inventory(entities, load_play_after_inventory=True):
                ...
                sources = tuple(
                    ...
                    if not (load_play_after_inventory and inventory_dir in basedirs)
                )
                return get_vars_from_inventory_sources(self._loader, sources, entities, stage)
